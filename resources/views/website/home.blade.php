    ...
    <header>
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item" style="background-image: url({{asset('website/img/22.jpgWeb')}})">
                    <div class="carousel-caption d-none d-md-block">
                    ...
                    @foreach($latestArticles as $latestArticle)
                        <div class="col-lg-4 mb-4">
                            <div class="card h-100">
                                <h4 class="card-header">{{$latestArticle->title}}</h4>
                                <img class="card-img-top" src="{{url('images/articles/'.$latestArticle->image)}}" alt="">
                                <div class="card-body">
                                    <p class="card-text">{{$latestArticle->short_description}}</p>
                                </div>
                                <div class="card-footer">
                                    <a href="{{route('news_details',[$latestArticle->id])}}" class="btn btn-primary">Read More...</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
