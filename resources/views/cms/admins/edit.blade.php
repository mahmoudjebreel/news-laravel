                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="first_name"
                                                       value='@if(old('first_name')) {{old('first_name')}} @else {{$admin->first_name}} @endif'
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="last_name"
                                                       value='@if(old('last_name')) {{old('last_name')}} @else {{$admin->last_name}} @endif'
                                                       type="text" class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <label>Mobile</label>
                                                <input name="mobile"
                                                       value='@if(old('mobile')) {{old('mobile')}} @else {{$admin->mobile}} @endif'
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                <label>Age</label>
                                                <input name="age"
                                                       value='@if(old('age')) {{old('age')}} @else {{$admin->age}} @endif'
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" value="Male" type="radio"
                                                           name="gender" @if($admin->gender == 'M') checked @endif>
                                                    <label class="form-check-label">Male</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" value="Female" type="radio"
                                                           name="gender" @if($admin->gender == 'F') checked @endif>
