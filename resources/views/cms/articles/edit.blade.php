                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-warning">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form role="form" method="post" id="update_article_form"
                                                ...
                                                <select class="form-control" name="category_id">
                                                    @foreach($categories as $category)
                                                        <option value="{{$category->id}}"
                                                                @if($article->category_id == $category->id) selected @endif>{{$category->title}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-9">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="article_title" value='{{$article->title}}'
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="article_short_description" class="form-control" rows="3"
                                                          placeholder="Enter short description...">{{$article->short_description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-9">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="article_full_description" class="form-control" rows="3"
                                                          placeholder="Enter full description...">{{$article->full_description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
