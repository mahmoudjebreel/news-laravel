                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-warning">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form id="create_category_form" role="form" method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-9">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="category_title" value='{{old('category_title')}}'
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="category_details" class="form-control" rows="3"
                                                          placeholder="Enter details...">{{old('category_details')}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="custom-control custom-switch">
                                            <input name="category_visibility_status" type="checkbox"
                                                   @if(old('category_visibility_status') == "on")
                                                   checked
                                                   @endif
